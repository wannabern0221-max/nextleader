(async () => {
  ...
  try {
    ...
    const canManageFiles = isDirector || hasAny(['file_manage']);
    ...
    root.innerHTML = `
      <div class="leader-home-welcome">
        ...
        <div class="leader-home-actions">
          ...
          ${canManageFiles ? '<a class="leader-home-action" href="file-manager.html"><span>09 · 파일 운영</span><strong>파일 관리</strong><small>파일 저장공간 사용량과 남은 용량을 확인하고 업로드 파일을 관리합니다.</small></a>' : ''}
