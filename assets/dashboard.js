    ...
    root.innerHTML = `
      <div class="leader-home-welcome">
        ...
        <div class="leader-home-actions">
          <a class="leader-home-action" href="internal-schedule.html"><span>01 · 일정 조율</span><strong>일정 확인</strong><small>정책1부·2부 리더가 불가능한 날짜를 표시하고 수석부장이 가능한 사업일을 확인합니다.</small></a>
          ...
          ${isDirector ? '<a class="leader-home-action" href="site-manager.html"><span>08 · 홈페이지 운영</span><strong>홈페이지 관리</strong><small>메인 문구와 환영 팝업 그리고 공개 메뉴 이름을 직접 변경합니다.</small></a>' : ''}
        </div>
      </div>
      <div class="member-layout">
        ...
        <section class="member-panel">
          ...
          <div class="portal-grid portal-grid-links">
            <a class="portal-card" href="internal-schedule.html"><span>01</span><strong>일정 응답 등록</strong><small>본인 부서의 참여 불가능한 날짜만 선택해 한 번에 제출합니다.</small></a>
